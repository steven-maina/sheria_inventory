...
// 	// 		form_data[i].parent().parent().addClass('warning');
			
// 	// 	}else{
// 	// 		form_data[i].parent().parent().removeClass('warning');
...
// 		//console.log("validate if statements starts");
// 		$.ajax({
