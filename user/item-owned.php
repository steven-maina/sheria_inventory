<?php 
include_once('../data/user_session.php');//check if any session otherwise it return to login
...
?>
  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
  	<div class="container-fluid">
		...
		<li>
          <a href="item-owned.php"><span class="glyphicon glyphicon-th"></span> Equipments</a>
        </li>
