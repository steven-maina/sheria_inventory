  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
  	<div class="container-fluid">
  	  ...
  	  <ul class="nav navbar-nav">
  	    ...
  	    <li>
          <a href="item.php"><span class="glyphicon glyphicon-object-align-vertical"></span>Equipments</a>
        </li>
...
<!-- 
        ...
        <li>
          <a href="office.php"><span class="glyphicon glyphicon-th"></span> Categories</a>
        </li>
  	 ...
  	 <ul class="nav navbar-nav navbar-right">
         <li class="dropdown">
            ...
            <li><a href="#modal-changepass" data-toggle="modal">Change Password</a></li>
              <li class="logout_btn"><a href="../data/admin_logout.php" onMouseOver="this.style.color='red'" 
               onMouseOut="this.style.color='blue'" >Logout</a></li>
              <style>.logout_btn{color:blue; }</style>
            </ul>
          </li>
      </ul>
 	 </div>
